...
async def post_new_recipe(recipe: RecipeIn, session: AsyncSession = Depends(get_session)):
...
async def get_deteil_recipe(recipe_id: int, session: AsyncSession = Depends(get_session)):
    '''
